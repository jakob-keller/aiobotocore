...
class AioLoader(Loader):
    ...
    def list_available_services(self, type_name):
        ...
        """
        return asyncio.create_task(self._list_available_services(type_name))

    async def _list_available_services(self, type_name):
        services = set()
    ...
    async def _load_service_model(
        ...
        known_services = await self.list_available_services(type_name)
